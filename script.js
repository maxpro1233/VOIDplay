...
const LANG = {
  uk: {
    ...
    game_poker_name: '♠️ Техаський покер',
    game_poker_desc: 'Техаський холдем за овальним столом. Збирай комбінації від пари до Роял-флешу!',
  ...
  ru: {
    ...
    game_poker_name: '♠️ Техасский покер',
    game_poker_desc: 'Техасский холдем за овальным столом. Собирай комбинации от пары до Роял-флеша!',
  ...
  en: {
    ...
    game_poker_name: '♠️ Texas Holdem',
    game_poker_desc: 'Texas holdem poker table. Collect combinations from a pair to a Royal Flush!',
